...
function enrichPlanWithNavigation(plan = {}, navigation = {}) {
	...
	return {
		...
		targetMapId: plan.targetMapId || navigation.finalTargetMapId || navigation.targetMapId || '',
		finalTargetMapId: navigation.finalTargetMapId || plan.finalTargetMapId || plan.targetMapId || '',
		nextMapId: navigation.nextMapId || plan.nextMapId || '',
		mapRoute: Array.isArray(navigation.mapRoute) && navigation.mapRoute.length ? navigation.mapRoute : Array.isArray(plan.mapRoute) ? plan.mapRoute : [],
